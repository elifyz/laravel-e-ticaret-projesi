        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="{{route('index')}}">Anasayfa</a> <span class="mx-2 mb-0">/</span>
                    <strong class="text-black">Sepetim</strong></div>
            </div>
        </div>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group mb-3" style="max-width: 120px;">
                                            ...
                                            <input type="text" class="form-control text-center" value="{{$cart['qty']}}" placeholder=""
                                    ...
                                    <td>
                                    <form action="{{route('sepetim.remove')}}" method="Post">
                                        @csrf
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>Kuponunuz varsa kupon kodunu giriniz</p>
                        </div>
                        <div class="col-md-8 mb-3 mb-md-0">
                            <input type="text" class="form-control py-3" id="coupon" placeholder="Kupon Kodu">
                        </div>
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-sm">Kupon Kodunu Onayla</button>
                        </div>
                    </div>
                </div>
